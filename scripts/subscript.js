...
function createquestion() {
    valOne = Math.floor(Math.random() * 100)+1; //between 1 to 10 (inclusive)
    valTwo = Math.floor(Math.random() * 100)+1; //between 1 to 10 (inclusive)
    ...
    questionText.textContent = total + " - " + valTwo; 
    
    answernum=total-valTwo;
}
